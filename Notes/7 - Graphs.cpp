...
int main () {
    ...
    cout << "Create and fill graphs" << endl;
    ...
    cout << "Connected components of graph 1: " << graphNonDirectional.howManyComponents();
    cout << "Connected components of graph 2: " << notConnected.howManyComponents();
}